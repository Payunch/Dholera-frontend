...
'X-CSRF-Token': csrfToken ||''
 ...
 <span className="bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-400 px-3 py-1 rounded-full text-[10px] font-black uppercase">
 {records.filter(r => r.status ==='awaiting_approval').length} Pending
 </span>
 <span className="bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 px-3 py-1 rounded-full text-[10px] font-black uppercase">
 ...
 <div className="h-16 w-16 bg-slate-50 dark:bg-slate-800 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-sm">
...
"bg-white dark:bg-slate-900 rounded-[1.5rem] p-6 border transition-all flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-sm",
...
"h-12 w-12 rounded-xl flex items-center justify-center shrink-0 transition-all",
 ...
 <span className="font-black text-slate-900 dark:text-white uppercase text-sm">{p.lead.name}</span>
...
"text-[10px] font-black uppercase",
 p.status ==='completed' ?"text-green-600 dark:text-green-400" :"text-orange-600 dark:text-orange-400"
 )}>
 UTR: {p.utr}
 </div>
 ...
 <div className="flex items-center gap-1 text-slate-900 dark:text-white font-black text-xl">
 ...
 className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:bg-orange-600 dark:hover:bg-orange-600 hover:text-white text-slate-900 dark:text-white px-8 py-4 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-2 shadow-xl shadow-slate-950/5"
 >
