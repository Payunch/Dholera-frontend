...
export function LeadsStats({ leads }) {
 ...
 <div 
 key={stat.label} 
 className={`flex items-center justify-between rounded-3xl border-2 p-8 shadow-sm transition-all hover:shadow-md dark:hover:shadow-black/100 ${stat.color}`}
 >
