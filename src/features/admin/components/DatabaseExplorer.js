...
"w-full flex items-center gap-2 p-2 rounded-lg text-left transition-all",
 ...
 <div className="h-10 w-10 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm flex items-center justify-center text-orange-600">
 ...
 className="p-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-400 dark:text-slate-500 hover:text-orange-600 dark:hover:text-orange-400 hover:border-orange-100 dark:hover:border-orange-900/30 transition-all shadow-sm"
 title="Refresh Data"
 >
 ...
 <div className="overflow-hidden border border-slate-200 dark:border-slate-800 sm:rounded-2xl shadow-sm bg-white dark:bg-slate-900">
