...
export function PdfListing() {
 ...
 <section className="py-24 bg-white dark:bg-[#0B132B] transition-colors dark:bg-slate-900" id="documents">
  ...
  <div className="flex items-center gap-2 text-[9px] font-black uppercase tracking-widest text-slate-505 dark:text-slate-400 bg-white dark:bg-slate-900 border border-slate-100 px-3 py-1.5 rounded-lg w-fit">
 ...
 "px-6 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest transition-all border-2",
  ...
  : "bg-white dark:bg-slate-900 border-slate-105 dark:border-slate-800 text-slate-400 hover:border-orange-600 hover:text-orange-600"
  )}
  >
  {tab.label}
  </button>
 ...
 "absolute top-4 left-4 h-8 w-8 rounded-full border-2 flex items-center justify-center transition-all",
  ...
  <div className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider text-slate-550 dark:text-slate-400">
  <Calendar className="h-3 w-3" />
  {formatUploadedAt(pdf)}
  </div>
  </div>
  <h3 className="font-display text-xl font-black text-slate-905 dark:text-white leading-tight line-clamp-2">
  {pdf.title}
  </h3>
 ...
 "w-full py-4 rounded-2xl font-black uppercase tracking-widest text-[10px] transition-all flex items-center justify-center gap-2",
  ...
  className="hidden md:block text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-orange-600 transition-colors border border-slate-202 dark:border-slate-700 px-3 py-1.5 rounded-lg"
  >
 ...
 "px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all",
  ...
  <span className="text-xl font-black text-slate-950 dark:text-white">₹{selectionTotal}</span>
  </div>
  <button 
  ...
  <p className="text-xs font-bold text-slate-550 dark:text-slate-400 uppercase tracking-widest mb-8">Secure UPI Payment Required</p>
