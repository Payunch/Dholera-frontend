...
// import { ShieldCheck, FileText, Search, Download, Filter, CheckCircle2, Lock } from 'lucide-react';
...
//         { label: t('tp_maps_count') || "TP Maps", key: "TP" },
//         { label: t('dp_maps_count') || "DP Maps", key: "DP" },
//         { label: t('circulars_count') || "Official Circulars", key: "Circular" }
//     ];
...
//                             <ShieldCheck className="h-4 w-4" /> {t('pdf_hub_title') || "Secure Document Archive"}
//                         </div>
...
//                         <input
//                             type="text"
//                             placeholder={t('search_pdf_placeholder') || "Search Documents..."}
//                             value={searchQuery}
//                             onChange={(e) => setSearchQuery(e.target.value)}
//                             className="w-full pl-14 pr-6 py-5 rounded-2xl bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-800 font-bold uppercase tracking-widest text-xs text-slate-900 dark:text-white placeholder-slate-650 outline-none focus:border-[#FF7A00] transition-all"
//                         />
//                     </div>
//                 </div>
//             </div>
...
//                         <Filter className="h-4 w-4" /> {t('pdf_types') || "Filter By Category"}
//                     </h3>
...
//                             <h3 className="text-lg font-black text-slate-900 dark:text-white uppercase mb-2">{t('no_projects_found') || "No Documents Found"}</h3>
//                             <p className="text-xs font-bold text-slate-500 uppercase tracking-widest">{t('adjust_search') || "Try adjusting your filters"}</p>
//                         </div>
//                     ) : (
...
//                                     className={cn(
//                                         "group bg-white dark:bg-slate-900 rounded-[2rem] md:rounded-[2.5rem] border border-slate-100 dark:border-slate-800 p-8 flex flex-col shadow-sm hover:shadow-2xl hover:border-[#FF7A00] hover:-translate-y-2 transition-all duration-500",
//                                         !verifiedLead && "opacity-80"
//                                     )}
//                                 >
...
//                                         </span>
//                                         <h4 className={cn(
//                                             "font-display text-base font-black text-slate-900 dark:text-white uppercase leading-tight line-clamp-3 group-hover:text-[#FF7A00] transition-colors duration-300",
//                                             !verifiedLead && "blur-[1.5px] select-none"
//                                         )}>
//                                             {pdf.title}
//                                         </h4>
//                                     </div>
...
//                                             </span>
//                                         </div>
//                                         <div className="p-2.5 rounded-xl bg-white dark:bg-slate-900 text-slate-900 dark:text-white group-hover:bg-[#FF7A00] transition-all shadow-lg shadow-slate-950/5 group-hover:shadow-orange-600/10 dark:group-hover:shadow-orange-600/30">
//                                             {verifiedLead ? (
