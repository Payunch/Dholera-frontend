...
const Slider = (props) => {
    ...
    const setSliderStyles = () => {
        ...
        return {
            width: (props.slides.length * 100) + 'vw',
            transform: 'translateX(' + transition + 'vw)'
        }
    }

    const renderSlides = () => props.slides.map((item, index) => (
        <div
    ...
    const renderDots = () => props.slides.map((silde, index) => ( // check index
        <li
...
export default HoCtToastContainer(Slider)