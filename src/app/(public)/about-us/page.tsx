  ...
  return (
    <div className="bg-white dark:bg-[#020617] text-slate-900 dark:text-slate-100 transition-colors duration-300 min-h-screen pb-32 w-full overflow-x-hidden font-sans">
      ...
      <div className="container mx-auto px-4 md:px-8 mt-24 max-w-[1600px]">
          ...
          {[
            ...
            <div key={i} className="group bg-white dark:bg-slate-900 rounded-[2rem] md:rounded-[2.5rem] overflow-hidden border border-slate-100 dark:border-slate-800 shadow-sm dark:shadow-white/5 hover:shadow-2xl dark:hover:shadow-black/100 hover:border-[#FF7A00] hover:-translate-y-2 transition-all duration-500 flex flex-col">
               <div className="relative h-56 w-full">
                  ...
                  <div className="absolute bottom-6 left-6 h-12 w-12 rounded-xl bg-white dark:bg-slate-900 flex items-center justify-center text-orange-600 shadow-lg dark:shadow-white/5 border border-slate-100 dark:border-slate-800">
        ...
        <div className="relative bg-white dark:bg-slate-900 rounded-[3rem] p-8 md:p-14 lg:p-20 border border-slate-200 dark:border-slate-800 shadow-xl dark:shadow-white/5 mb-32 flex flex-col lg:flex-row items-center gap-12 lg:gap-20 group hover:shadow-2xl dark:hover:shadow-black/100 transition-all duration-500 overflow-hidden">
           ...
           {/* Founder Image */}
           <div className="relative z-10 w-full lg:w-[400px] shrink-0 aspect-[4/5] rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl dark:shadow-white/10 group-hover:-translate-y-2 transition-transform duration-500 border border-white/10">
              <Image 
                src="/images/ng.png" 
