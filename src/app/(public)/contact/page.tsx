        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          <div className="space-y-12">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6">
              <div className="flex items-start gap-6 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 transition-all hover:bg-white dark:hover:bg-slate-900 hover:shadow-2xl hover:border-[#FF7A00] group">
