    ...
    <div className="bg-white min-h-screen pb-32 w-full overflow-x-hidden">
      ...
      <section className="relative bg-[#0B132B] pt-32 pb-24 border-b border-slate-800 overflow-hidden mb-24">
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-8 text-center space-y-6">
          <div className="inline-flex items-center rounded-full bg-slate-900/50 border border-slate-700 px-5 py-2 text-[10px] font-black uppercase tracking-[0.4em] text-white backdrop-blur-sm">
      ...
      <div className="container mx-auto px-4 md:px-8">
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
          <div className="space-y-10">
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="p-8 bg-slate-50 rounded-[2rem] border border-slate-100 hover:shadow-xl transition-all duration-500 group">
                ...
                <div className="text-[10px] font-black uppercase tracking-widest text-slate-400">Sq KM Total Area</div>
              </div>
              <div className="p-8 bg-slate-50 rounded-[2rem] border border-slate-100 hover:shadow-xl transition-all duration-500 group">
          ...
          <div className="relative aspect-video bg-slate-950 rounded-[3rem] overflow-hidden shadow-2xl group">
             <Image 
             ...
             <div className="absolute inset-0 flex items-center justify-center">
                <div className="h-20 w-20 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white">
                   <Construction className="h-8 w-8 animate-pulse" />
                </div>
             </div>
             <div className="absolute bottom-8 left-8">
                <span className="px-4 py-2 bg-orange-600 text-white text-[10px] font-black uppercase tracking-widest rounded-lg">Real-time Growth</span>
             </div>
          </div>
        </section>
        ...
        <div className="bg-slate-900 rounded-[3rem] p-12 md:p-24 text-white text-center relative overflow-hidden">
           ...
           <p className="text-slate-400 font-medium max-w-2xl mx-auto uppercase tracking-widest text-xs leading-loose mb-12 relative z-10">
