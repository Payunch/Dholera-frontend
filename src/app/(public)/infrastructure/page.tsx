        ...
        <div className="container mx-auto px-4 md:px-8 max-w-[1600px]">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-10">
            {categories.map((cat, i) => (
              <div key={i} className="bg-white dark:bg-[#111A35] p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-xl dark:shadow-white/5 shadow-slate-200/10 dark:shadow-white/10 hover:-translate-y-2 transition-all group flex flex-col">
           ...
           <div className="bg-white dark:bg-slate-900 rounded-[3rem] p-8 md:p-20 text-slate-900 dark:text-white overflow-hidden relative">
              ...
              <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
                 <div className="space-y-8">
                    ...
                    <div className="pt-4">
                       <Link href="/tp-maps" className="inline-flex items-center gap-3 bg-orange-600 hover:bg-orange-500 text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest text-xs transition-all shadow-xl dark:shadow-white/5 shadow-orange-600/10 dark:shadow-orange-600/50">
