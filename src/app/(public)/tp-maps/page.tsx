                 ...
                 {filters.map(filter => (
                    <button
                      ...
                      className={cn(
                        ...
                        activeFilter === filter 
                          ? "bg-[#FF7A00] text-white border-[#FF7A00] shadow-lg shadow-orange-600/10 dark:shadow-white/5 dark:shadow-orange-600/50" 
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8 lg:gap-10 max-w-[1600px] mx-auto">
                {filteredList.map((tp) => (
                  <Link 
                    ...
                    className="group relative p-8 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-white dark:bg-[#111A35] border border-slate-100 dark:border-slate-800 shadow-sm dark:shadow-white/5 hover:shadow-2xl hover:-translate-y-2 hover:border-[#FF7A00] transition-all duration-500 flex flex-col justify-between"
                  >
                     {/* Psychology Badges */}
