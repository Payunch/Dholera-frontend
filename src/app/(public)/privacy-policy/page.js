...
export default function PrivacyPolicy() {
 ...
 <p className="mb-10 text-sm font-bold tracking-widest text-slate-500 uppercase">Last updated 20, 2026</p>
 ...
 Payments are handled securely by Razorpay. We do not store your banking credentials or card details. Your document access is tied to your mobile number and verified via a secure session token.
  ...
  <section>
  <h2 className="text-2xl font-black uppercase mb-4 text-slate-900 dark:text-white">6. Law Enforcement & Compliance</h2>
  <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
  We reserve the right to disclose any information about you to government or law enforcement officials as we, in our sole discretion, believe necessary or appropriate to respond to claims and legal process, to protect the property and rights of the platform, to protect the safety of the public or any person, or to prevent or stop activity we may consider to be, or to pose a risk of being, illegal, unethical, or legally actionable.
  </p>
  </section>
  </div>
  </div>
