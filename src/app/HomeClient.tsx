...
export function HomeClient() {
  ...
  return (
    <div className="flex flex-col bg-white">
      ...
      {/* 1.1 HERO SECTION */}
      <section className="relative w-full min-h-[90vh] bg-slate-900 flex items-center justify-center overflow-hidden border-b border-slate-800">
        {/* Abstract GIS Background */}
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-[#0B132B]" />
          {/* Interactive Grid */}
          <div className="absolute inset-0 grid grid-cols-6 sm:grid-cols-12 md:grid-cols-20 grid-rows-12 gap-px opacity-20">
            {Array.from({ length: 240 }).map((_, i) => (
              <div 
                ...
                className={cn(
                  "w-full h-full border border-slate-700 transition-all duration-300",
