...
- **WhatsApp OTP Integration**: Replaced Firebase SMS with a direct WhatsApp Business API integration for secure OTP delivery to avoid Google Cloud / Blaze Plan billing issues.
- **Improved Lead Popups**: Re-wired `LeadPopup.tsx` to handle backend-generated OTPs seamlessly without Firebase dependencies.
- **Contact Page Link**: Added the "Contact Us" link to the main top navigation (`Navbar.tsx`).
- **Site Visit Automation**: Replaced the manual `wa.me` redirect on the homepage with a silent, background API submission that triggers automated Welcome and Follow-up sequences.
...
# fingerpront:2F:77:70:E9:C0:71:A4:5A:F6:5E:60:DD:C1:D7:92:11:D6:10:37:F7:93:96:09:44:9A:E7:79:31:65:F2:0C:17